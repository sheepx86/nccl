...
#define F_A2A (1u << ncclFuncAlltoAll)
...
//   symmetric  -> bit (NCCL_TUNING_SYM_KERNEL_ID_OFFSET + symKernelId), the [21,40) space
...
static constexpr struct ncclAlgRegEntry algRegistry[] = {
  ...
  // Symmetric AlltoAll kernels
  {"SYMK_FullGin_LsaST",      ALGBIT(39), F_A2A, -1, -1, ncclSymkKernelId_AlltoAll_FullGin_LsaST},
};
// clang-format on
